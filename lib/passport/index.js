...
Passport.prototype.initStrategy = function(req, res, next) {
  ...
  // var strategySettings = this.getStrategySettings(req.params.appId, 'facebook', function(result) {
  //   var strategy = this.strategyFactory('facebook', result);
  //   _next();
  // })

  return initStrategy(req, res, next).bind(this);
}


Passport.prototype.strategyFactory = function(providerName, result){
  /* FACEBOOK STRATEGY */

  this.use('miastr', new FacebookStrategy({

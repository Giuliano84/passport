...
Passport.prototype.initStrategy = function(req, res, next) {
  ...
  this.getStrategySettings(req.params.appId, 'facebook', function(result) {
    _this.strategyFactory('facebook', result);
    _this.authenticate('facebook')(_req, _res, _next);
  })
}
